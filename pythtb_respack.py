...
class w90(object):
    ...
    *prefix*\_centres.dat) one needs to include the following flags in the win
    ...
    def model(self,zero_energy=0.0,min_hopping_norm=None,max_distance=None,ignorable_imaginary_part=None,nspin=2,soc=0.):
        """
        ...
        *projections* block or the *prefix*.nnkp file to see which
        ...
        tb=tb_model(3,3,self.lat,self.red_cen,nspin=nspin,soc=soc)
